...
#set species
species <- "larselli-vandykei-idahoensis"
...
#run model
eval1 <- ENMevaluate(gps, envs, bg, method=c('checkerboard1'), RMvalues=c(1, 2, 3), fc=c("L", "LQ", "H", "LQH", "LQHP", "LQHPT"), algorithm='maxent.jar')
